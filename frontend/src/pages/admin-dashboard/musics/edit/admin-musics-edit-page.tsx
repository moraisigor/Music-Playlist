...
import { createMusic, listAllMusics, updateMusic } from "../../../../services/music_service";
import { listAllPlans, listPlansByMusic } from "../../../../services/plan_service";
import './admin-musics-edit-page.css'

interface EditMusicProps {
    isNew: boolean;
}

function AdminMusicsEditPage(props: EditMusicProps) {
        ...
        <div className="adminMusics">
            ...
            <div className="adminMusicsBody">
                <div className="adminMusicsCard">
                    ...
                    <div className="adminMusicsEditBody">
                        {
                            loading
                            ? <CircularLoader />
                            : (
...
export default AdminMusicsEditPage;